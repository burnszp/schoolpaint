...
public class Pic {
    ...
    public static void main(String[] args) {
        ...
        BufferedImage d = tt.loadImageLocal("C:/burns/schoolpaint/ico.png");
        BufferedImage b = tt.loadImageLocal("C:/burns/schoolpaint/wwby_ct_text.png");  
        //往图片上写文件  
        //tt.writeImageLocal("E:\\ploanshare\\2\\22.jpg", tt.modifyImage(d, "000000", 90, 90));

        tt.writeImageLocal("C:/burns/schoolpaint/ico1.png", tt.modifyImagetogeter(b, d));  
        //将多张图片合在一起  
