...
public class PsImage {
    ...
    public String rotate(int angle){
    	String destFilePath = originImage.getParent()+"/"+System.currentTimeMillis()+".png";
        ...
        try {
			ImageIO.write(dealedImage, "png", new File(destFilePath));
		} catch (IOException e) {
    ...
    public static void main(String[] args) throws IOException {
    	String imagePath = "D:/eclipse_wks/SchoolPaint_8/images/wwby.png";
    	File image = new File(imagePath);
		PsImage psi = new PsImage(image);
		psi.rotate(180);
	}
